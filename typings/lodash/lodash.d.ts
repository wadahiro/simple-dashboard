...
declare module _ {
    ...
    **/
    ...
    interface LoDashImplicitArrayWrapper<T> {
         ...
         * @see _.flatten
         **/
        flatten<T>(): LoDashImplicitArrayWrapper<T>;

        /**
         * @see _.flatten
         **/
        flatten<T>(isShallow: boolean): LoDashImplicitArrayWrapper<T>;
    }
    ...
    interface LoDashExplicitArrayWrapper<T> {
         ...
         * @see _.flatten
         **/
        flatten<T>(): LoDashExplicitArrayWrapper<T>;

        /**
         * @see _.flatten
         **/
        flatten<T>(isShallow: boolean): LoDashExplicitArrayWrapper<T>;
    }
    ...
    interface LoDashExplicitArrayWrapper<T> {
        ...
        * @see _.uniq
        **/
        uniq<TSort>(isSorted?: boolean): LoDashExplicitArrayWrapper<T>;
